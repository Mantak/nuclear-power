...
const Feedback = () => {
  ...
  return(
    <div>
      <div className="weui-cells__title" style={{paddingTop: 10}}>
        意见反馈方式
      </div>
      <div className="weui-cells">
        <div className="weui-cell">
          <div className="weui-cell__hd"><i className="teal call icon"/></div>
        ...
        <div className="weui-cell">
          <div className="weui-cell__hd"><i className="blue mobile icon"/></div>
          <div className="weui-cell__bd">
            <p>手机</p>
          </div>
        ...
        <div className="weui-cell">
          <div className="weui-cell__hd"><i className="brown mail icon"/></div>
          <div className="weui-cell__bd">
            <p>邮箱</p>
          </div>
        ...
        <div className="weui-cell">
          <div className="weui-cell__hd"><i className="olive home icon"/></div>
          <div className="weui-cell__bd">
            <p>地址</p>
          </div>
