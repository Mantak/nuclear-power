      ...
      <div className="weui-flex">
        ...
        <div className="weui-flex__item" style={contentBoxStyle}>
          <div style={{padding: 5}}>
            ...
            <p style={{height:'2.95em', lineHeight: '1em', overflow: 'hidden'}}>单位: <span style={{color: 'grey'}}>{expert.unit}</span></p>
            <p>研究方向:<span style={{color: 'grey'}}>{expert.research}</span></p>
          </div>
        </div>
      </div>
    </div>
...
class ExpertDetail extends React.Component {
  ...
  render() {
    ...
    const expert = ExpertArr.sort((a,b) => a.order - b.order)[order-1]
    return (
      <div>
        ...
        <div className="weui-cells__title">简介</div>
