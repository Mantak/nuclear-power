...
import CommitteeList from './components/committee_list.jsx'
import ReviewerList from './components/reviewer_list.jsx'
...
export default function (injectDeps, {FlowRouter}) {
 ...
 //主页
  ...
  router('committeelist', <CommitteeList />)
  router('reviewerlist', <ReviewerList />)
